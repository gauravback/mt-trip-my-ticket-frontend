import DubaiActivitiesFilter from "@/components/SearchComponents/DubaiActivitiesFilter/DubaiActivitiesFilter";
...
const DubaiActivities = () => {
  ...
  <div className="relative mx-auto w-full">
    <a href="#" className="relative inline-block duration-300 ease-in-out transition-transform transform hover:-translate-y-2 w-full">
     ...
     <div className="mt-12 mx-auto max-w-2xl pb-16 px-4 sm:px-6 lg:max-w-7xl lg:px-8 ">
      <h1 className="text-2xl font-bold mb-9">Top Experiences in Abu Dhabi</h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 w-full">
  <div className="relative mx-auto w-full">
    <a href="#" className="relative inline-block duration-300 ease-in-out transition-transform transform hover:-translate-y-2 w-full">
      <div className="shadow p-4 rounded-lg bg-white">
