...
import image from "../components/Media/caro1.webp";
...
import most2 from "../components/Media/most2.avif";
import most3 from "../components/Media/most3.avif";
import chill from "../components/Media/chill.avif";
import chill1 from "../components/Media/chill1.avif";
import safe from "../components/Media/safe.jpg";
import safe1 from "../components/Media/safe1.jpg";
import safe2 from "../components/Media/safe2.jpg";
import "./Home.css";
const Home = () => {
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <Offers />
        <div className="solt-cont">
          <h1>Atlantis Aquaventure Waterpark</h1>
          <Slider {...settings}>
            <div className="hi">
              <img src={image2} alt="" />
            </div>
        ...
        <div className="hi-cont-2">
          <h1>Top Cities to Visit</h1>
          <Slider {...settings1}>
            <div className="hi-cont1">
              <img src={abu1} className="image" alt="" />
              <div className="middle">
                <div className="text">Abu Dhabi</div>
              </div>
            </div>
            <div className="hi-cont1">
              <img src={abu2} className="image" alt="" />
              <div className="middle">
                <div className="text">Dubai</div>
              </div>
            </div>
            <div className="hi-cont1">
              <img src={abu3} className="image" alt="" />
              <div className="middle">
                <div className="text">Ras al Khaimah</div>
              </div>
            </div>
            <div className="hi-cont1">
              <img src={abu4} className="image" alt="" />
              <div className="middle">
        ...
        <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
          ...
          <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 md:gap-20 md:grid-cols-3 lg:grid-cols-5 lg:gap-8">
            ...
            <div className="text-center">
              ...
              <div className="mt-2 sm:mt-6">
                <p className="text-gray-800 dark:text-gray-200">
                  " Truly great places and costumer support. "
                </p>
              </div>
              {/* Star */}
            ...
            <div className="text-center">
              ...
              <div className="mt-2 sm:mt-6">
                <p className="text-gray-800 dark:text-gray-200">
                  " This is a truly beautiful places. "
                </p>
              </div>
              {/* Star */}
              <div className="flex-shrink-0 flex justify-center space-x-1 mt-3">
            ...
            <div className="text-center">
              ...
              <div className="mt-2 sm:mt-6">
                <p className="text-gray-800 dark:text-gray-200">
                  " Great services and thorough wibes. "
                </p>
              </div>
              {/* Star */}
              <div className="flex-shrink-0 flex justify-center space-x-1 mt-3">
        ...
        <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
          {/* Grid */}
          <h1
            style={{ marginBottom: "5%", fontSize: "28px", fontWeight: "700" }}
          >
              ...
              <div className="sm:flex">
                ...
                <div className="grow mt-4 sm:mt-0 sm:ml-6 px-4 sm:px-0">
                  ...
                  <p className="mt-3 text-gray-600 dark:text-gray-400">
                    AYA at WAFI City Mall invites you to a universe that is
            ...
            <a className="group rounded-xl overflow-hidden" href="#">
              <div className="sm:flex">
                ...
                <div className="grow mt-4 sm:mt-0 sm:ml-6 px-4 sm:px-0">
                  ...
                  <p className="mt-3 text-gray-600 dark:text-gray-400">
                    As a great attraction ideal for all age groups, it is
                    certain that these wonderfully friendly mammals will amaze
                    you throughout .
                  </p>
                  <p className="mt-4 inline-flex items-center gap-x-1.5 text-blue-600 decoration-2 hover:underline font-medium">
                    Read more
            ...
            <a className="group rounded-xl overflow-hidden" href="#">
              <div className="sm:flex">
                ...
                <div className="grow mt-4 sm:mt-0 sm:ml-6 px-4 sm:px-0">
                  ...
                  <p className="mt-3 text-gray-600 dark:text-gray-400">
                    Our Evening Desert Safari is one of our best-priced desert
                    packages;
                  </p>
                  <p className="mt-4 inline-flex items-center gap-x-1.5 text-blue-600 decoration-2 hover:underline font-medium">
                    Read more
            ...
            <a className="group rounded-xl overflow-hidden" href="#">
              <div className="sm:flex">
                ...
                <div className="grow mt-4 sm:mt-0 sm:ml-6 px-4 sm:px-0">
                  ...
                  <p className="mt-3 text-gray-600 dark:text-gray-400">
                    IMG Worlds of Adventure welcomes you to revel in its
                    compelling blend
                  </p>
                  <p className="mt-4 inline-flex items-center gap-x-1.5 text-blue-600 decoration-2 hover:underline font-medium">
                    Read more
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a className="group rounded-xl overflow-hidden" href="#">
              ...
              <div className="mt-7">
                ...
                <p className="mt-3 text-gray-800 dark:text-gray-200">
                  Enjoy a memorable evening aboard a traditional Arabian boat
                  ‘Dhow’ along the corniche.
                </p>
            ...
            <a className="group rounded-xl overflow-hidden" href="#">
              ...
              <div className="mt-7">
                ...
                <p className="mt-3 text-gray-800 dark:text-gray-200">
                  Looking for an ultimate desert safari experience that also
                  allows you to soak in the real Arabian charm?
                </p>
                <p className="mt-5 inline-flex items-center gap-x-1.5 text-blue-600 decoration-2 group-hover:underline font-medium">
                  Read more
                  <svg
            ...
            >
              <div className="flex-auto p-4 md:p-6">
                <h3 className="text-xl text-white/[.9] group-hover:text-white">
                  <span className="font-bold">MyTripMyTicket</span> Discover the
                  best attractions and activities that the UAE's capital city
                  has to offer.
                </h3>
              </div>
              ...
              <div className="absolute bottom-0 inset-x-0 z-10">
                <div className="flex flex-col h-full p-4 sm:p-6">
                  ...
                  <p className="mt-2 text-white/[.8]">
                    Delight in its lush settings and visit Liwa’s natural
                    wonders such as Tal Moreeb
                  </p>
                </div>
              </div>
            </a>
              ...
              <div className="space-y-6 sm:space-y-8">
                ...
                <div className="space-y-2 md:space-y-4">
                  ...
                  <p className="text-gray-500">
                    Enjoy an authentic Arabian adventure as you journey out of
                    Abu Dhabi’s
                  </p>
                </div>
                {/* End Title */}
                ...
                <ul role="list" className="space-y-2 sm:space-y-4">
                  <li className="flex space-x-3">
                    ...
                    <span className="text-sm sm:text-base text-gray-500">
                      <span className="font-bold">Pick up from your Hotel</span>{" "}
                      – more creativity
                    </span>
                  </li>
                  <li className="flex space-x-3">
                  ...
                  <li className="flex space-x-3">
                    ...
                    {/* End Solid Check */}
                    <span className="text-sm sm:text-base text-gray-500">
                      Enjoy a delicious picnic lunch at a palm-fringed oasis{" "}
