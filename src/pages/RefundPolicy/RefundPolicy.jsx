...
const RefundPolicy = () => {
  return (
    <div>
      <div className="max-w-[85rem] mx-auto prose mt-12">
        <h1>Return and Refund Policy</h1>
        <p>Last updated: September 05, 2023</p>
        <p>Thank you for shopping at My Trip My Ticket.</p>
        <p>
        ...
        <ul>
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to My Trip My
              Ticket.
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            <p>By email: contact@taketotrip.com</p>
          </li>
          <li>
            <p>
