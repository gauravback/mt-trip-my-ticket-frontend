    ...
    <footer>
      <div className="footerTerms" id="footercol"> 
        <div className="footerCard">
          ...
          <p>
            Established in 2000, MytripMyticket has since positioned itself as one
        ...
        <div className="footerCard">
          ...
          <p>
            At MytripMyticket, you can find the best of deals and cheap air tickets
            ...
            bookings, MytripMyticket helps you book flight tickets that are
            ...
            over 5 million happy customers, we at MytripMyticket are glad to fulfill
        ...
        <div className="footerCard">
          ...
          <p>
            MytripMyticket is India's leading player for flight bookings. With the
